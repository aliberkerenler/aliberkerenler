<h1 align="center">Hi 👋, I'm Ali Berke Erenler</h1>
...
### 🚀 About Me
- 🎓 **Computer Engineering** student at **Kocaeli University** (Senior)
- 🏫 Active learner in **42 Istanbul** (Core Curriculum) focusing on Unix/POSIX, multithreading, and low-level C
- 💼 Former **Software Engineering Intern** at **Turkcell Gaming Technologies (GAME+)**, developing microservices (Spring Boot), Redis integrations, and CMS components (React)
- ⚙️ Interested in **Distributed Systems**, **Concurrent Programming**, and **Scalable Backend Architectures**
- 💬 Ask me about **Java/Spring Boot**, **C/System Calls**, **FastAPI**, or **Concurrency**
...
**DevOps, System & Testing**
<p align="left">
  <img src="https://img.shields.io/badge/Linux_/_POSIX-FCC624?style=for-the-badge&logo=linux&logoColor=black" />
